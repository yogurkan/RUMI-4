                ...
                <table class="w-full">
                    <thead>
                        <tr class="text-md font-semibold tracking-wide text-left text-gray-900 bg-gray-100 uppercase border-b border-gray-600">
                            ...
                            <th class="px-4 py-3">Reach Member</th>
                    ...
                    <tbody class="bg-white">
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            $donor_birthdate = $row["donor_birthdate"];
                            $donor_address = $row["donor_address"];
                            $member_ID = $row["member_id"];

                            echo "
                            <tr class='text-gray-700'>
                                <td class='px-4 py-3 text-ms font-semibold border'>$donor_id</td>
                                <td class='px-4 py-3 border'>
                                    <div class='flex items-center text-sm'>
                                        <div class='relative w-8 h-8 mr-3 rounded-full md:block'>
                                        <img class='object-cover w-full h-full rounded-full' src='img/donor.png' alt='' loading='lazy' />                                            

                                            <div class='absolute inset-0 rounded-full shadow-inner' aria-hidden='true'></div>
                                        </div>
                                        <div>
                                            <p class='font-semibold text-black'>$donor_name</p>
                                            <p class='text-l fond-bold text-gray-600'>$donor_lastname</p>
                                        </div>
                                    </div>
                                </td>
                                <td class='px-4 py-3 text-ms font-semibold border'>$donor_mail</td>
                                
                                <td class='px-4 py-3 text-sm border'>$donor_birthdate</td>
                                <td class='px-4 py-3 text-sm border'>$donor_address</td>
                                <td class='px-4 py-3 text-sm border'>$member_ID</td>
                                <td class='px-4 py-3 text-sm border'><a href='mailto:" . $donor_mail . "' class='inline-block bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded'>Reach</a></td>                            ";
                        }
                        // Free the result set
