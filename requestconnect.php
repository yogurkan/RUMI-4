...
$indigent_income = $_POST['monthlyincome'];
$indigent_household = $_POST['household'];
...
VALUES ('$indigent_name', '$indigent_lastname', $indigent_phone, '$indigent_address', '$indigent_income', '$indigent_household', '$indigent_children','$education_status_string', '$indigent_employment', '$indigent_expenditures', '$indigent_support')";
