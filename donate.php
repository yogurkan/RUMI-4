...
$query2 = "INSERT INTO donations(donation_area,donation_project,donation_type,donation_amount,donation_material_type,donation_shipping_type,donor_id,donation_date, isShipped) 
    VALUES('$area','$project','$donate_type','$donate_amount','$material_type','$shipping_type','$donor_id','$donation_date','$isShipped')";
...
<body class="flex items-center justify-center h-screen bg-gray-100">
    <div class="text-center">
        ...
        <p class="mb-8">If you choose NGO for shipping type, NGO will conact with you.</p>
